...
import com.eliasjr.brasilprev.constant.SecurityConstants;
...
public class JwtManager {
	...
	public Claims parseToken(String jwt) throws JwtException {
		Claims claims = Jwts.parser().setSigningKey(SecurityConstants.API_KEY.getBytes()).parseClaimsJws(jwt).getBody();
		return claims;
	}
}
